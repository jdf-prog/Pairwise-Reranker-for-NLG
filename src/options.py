...
class Options():
    ...
    def _add_optim_options(self):
        ...
        self.parser.add_argument('--source_encoder_lr', type=float, default=2.5e-4, help='learning rate')
        self.parser.add_argument('--candidate_encoder_lr', type=float, default=7.5e-4, help='learning rate')
