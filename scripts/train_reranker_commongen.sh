...
train_data_path="./data/prepared/${dataset}/train/dataset.old.jsonl"
dev_data_path="./data/prepared/${dataset}/val/dataset.old.jsonl"
...
#     --run_name "train_commongen_top_bottom_4_method" \
...
#     # --reset_scores True \
#     # --resume_from_checkpoint "./outputs/crosscompare/microsoft/deberta-v3-large/train_commongen_moe/checkpoint-3159" \
#     # --inference_mode "full"
