...
dataset="wmt18_${candidate_model}"
...
#     --run_name "test_wmt18_${candidate_model}_PairReranker_full_comparison" \
...
#     --run_name "test_wmt18_${candidate_model}_PairReranker" \
#     --train_data_path ${train_data_path} \
#     --eval_data_path ${dev_data_path} \
#     --test_data_path ${test_data_path} \
#     --n_candidates 30 \
...
train_reranker.py \
    ...
    --model_type "xlm-roberta" \
    --model_name "xlm-roberta-large" \
    --run_name "test_wmt18_${candidate_model}_SummaReranker" \
    --train_data_path ${train_data_path} \
    --eval_data_path ${dev_data_path} \
    --test_data_path ${test_data_path} \
    --n_candidates 30 \
