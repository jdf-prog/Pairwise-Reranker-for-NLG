#!/bin/bash
#SBATCH --time=1:00:00
#SBATCH --job-name=test_gpt3_commongen
...
dataset="commongen_${candidate_model}"
...
#     --run_name "test_commongen_${candidate_model}_PairReranker_full_comparison" \
...
#     --run_name "test_commongen_${candidate_model}_PairReranker" \
#     --train_data_path ${train_data_path} \
#     --eval_data_path ${dev_data_path} \
#     --test_data_path ${test_data_path} \
#     --n_candidates 30 \
...
#     --model_type "roberta" \
#     --model_name "roberta-large" \
#     --run_name "test_commongen_${candidate_model}_SummaReranker" \
#     --train_data_path ${train_data_path} \
#     --eval_data_path ${dev_data_path} \
#     --test_data_path ${test_data_path} \
#     --n_candidates 30 \
